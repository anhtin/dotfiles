#!/bin/sh
# Base16 Seti - Shell color setup script
...
color08="23/53/5B" # Base 03 - Bright Black
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pj 55B5DB # selection color
